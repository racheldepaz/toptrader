...
export default function MultiStepSignupModal({ isOpen, onClose }: MultiStepSignupModalProps) {
  ...
  const handleProfileSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    console.log('👤 handleProfileSubmit: Starting profile submission', { username, displayName });
    
    if (!username.trim()) {
      console.log('❌ handleProfileSubmit: No username provided');
      return;
    }
    ...
    try {
      ...
      console.log('👤 handleProfileSubmit: Profile creation response:', {
        data,
        error: profileError
      });
      ...
      <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4">
        ...
        {signupStep === 'email' && (
          <div>
            ...
            <button 
              disabled 
              className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-md bg-gray-100 text-gray-400 mb-4 cursor-not-allowed"
            >
